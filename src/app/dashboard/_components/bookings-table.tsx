...
export const BookingsTable = (props: {
  ...
  return (
    <Fragment>
      <Tabs
        defaultValue="week"
        className="grid gap-4 md:gap-8 grid-cols-1"
        onValueChange={(val) => setSelectedTab(val as "week" | "month" | "year")}>
        <div>
          <div className="flex items-center lg:col-span-2 xl:col-span-3 mb-4 md:mb-8">
            <TabsList>
              {tabs.map((tab, idx) => (
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button className="w-72">Booking Details</Button>
          </DialogTrigger>
          <DialogContent className="w-full max-w-2xl">
            <Card className="mt-2 border-none bg-transparent" x-chunk="dashboard-05-chunk-4">
